  ...
  return (
    <main className="min-h-screen bg-[#f4f9f4] text-green-950 font-sans selection:bg-green-200 overflow-x-hidden">
      ...
      <section className="relative w-full mt-[112px] min-h-[calc(100vh-112px)] overflow-hidden flex items-center group">
        {/* Background Image (Colorful wooden handmade dolls and toys) */}
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-py9YFq1mDYA?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center bg-no-repeat transition-transform duration-1000 group-hover:scale-105"></div>
